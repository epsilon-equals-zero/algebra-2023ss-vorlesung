...
\begin{remark}\label{rem:nebenklassenzerlegung_endlich}
    Ist $G$ eine Gruppe, dann gilt $\vert G \vert = \vert \{gU \mid g \in G\} \vert \cdot \vert U \vert$, da alle Linksnebenklassen gleich mächtig sind. Falls $G$ endlich ist, erhalten wir durch Umformen $\vert \{gU \mid g \in G\} \vert = \frac{\vert G \vert}{\vert U \vert}$. Mit dem analogen Result für Rechtsnebenklassen folgt dann, dass es gleich viele Linksnebenklassen wie Rechtsnebenklassen gibt.
